...
namespace CRM
{
    public partial class naujaimone : Form
    {
        public naujaimone()
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                string query = "INSERT INTO IMONE (IMONES_PAV, IMONES_PVM, IMONES_PASTAS, IMONES_ADRESAS ) VALUES" + " ('" + textBox1.Text + "','" + textBox2.Text + "','" + textBox3.Text + "','" + textBox4.Text + "') ";
